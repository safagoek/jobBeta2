...
--
-- Host: 127.0.0.1
-- Generation Time: May 30, 2025 at 12:33 AM
...
CREATE TABLE `applications` (
  ...
  `cv_feedback` text DEFAULT NULL COMMENT 'AI-generated feedback on the CV-job match'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `application_answers` (
  ...
  `answer_feedback` text DEFAULT NULL COMMENT 'AI-generated feedback for the answer'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Table structure for table `job_template_configs`
--

CREATE TABLE `job_template_configs` (
  `id` int(11) NOT NULL,
  `job_id` int(11) NOT NULL,
...
--
-- Indexes for table `job_template_configs`
--
ALTER TABLE `job_template_configs`
  ADD PRIMARY KEY (`id`),
  ADD KEY `job_id` (`job_id`),
...
--
-- AUTO_INCREMENT for table `job_template_configs`
--
ALTER TABLE `job_template_configs`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `job_template_configs`
--
ALTER TABLE `job_template_configs`
  ADD CONSTRAINT `job_template_configs_ibfk_1` FOREIGN KEY (`job_id`) REFERENCES `jobs` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `job_template_configs_ibfk_2` FOREIGN KEY (`template_id`) REFERENCES `question_templates` (`id`) ON DELETE CASCADE;
