...
if (isset($_GET['delete']) && is_numeric($_GET['delete'])) {
    ...
    try {
        ...
        if (isset($_GET['confirm']) && $_GET['confirm'] == 'yes') {
            ...
            // job_template_configs tablosunu kullanarak doğru ilişkiyi kur
            $stmt = $db->prepare("SELECT COUNT(*) FROM job_template_configs WHERE template_id = :template_id");
            $stmt->bindParam(':template_id', $template_id, PDO::PARAM_INT);
            $stmt->execute();
...
$sql = "
    SELECT 
        ...
        (SELECT COUNT(*) FROM job_template_configs WHERE template_id = qt.id) as usage_count
    FROM 
